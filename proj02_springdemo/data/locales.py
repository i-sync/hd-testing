...
Closing = ["en_IN", "th_TH", "ko_KR", "vi_VN", "en_GU", "en_ZZ", "pt_BR", "id_ID", "en_AP", "es_MX", "en_GB", "en_IE", "fr_FR", "en_AA", "el_GR", "es_ES", "pt_PT", "it_IT", "en_AU", "en_EU", "hu_HU", "cs_CZ", "pl_PL", "zh_TW"]

Online = ["es_XX", "en_CA", "fr_CA", "de_AT", "de_DE", "fr_CH", "it_CH", "de_CH", "fr_BE", "nl_BE", "fr_LU", "nl_NL", "no_NO", "sv_SE", "da_DK", "fi_FI"]
